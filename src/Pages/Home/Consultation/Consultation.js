        ...
        <div className="consultation">
            <div className="not-found-wrapper d-flex justify-content-center align-items-center">
                <div className="text-center">
                    ...
                    <Link to="/appointment"><Button variant="info" className="px-4 border-0 mb-4">Start Video Chat <FontAwesomeIcon icon={faVideo} className="ms-2 text-white" /></Button></Link>
                </div>
            </div>
        </div>
    );
